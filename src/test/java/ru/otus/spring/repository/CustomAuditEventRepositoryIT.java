...
import static ru.otus.spring.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
import ru.otus.spring.config.audit.AuditEventConverter;
import ru.otus.spring.domain.PersistentAuditEvent;
